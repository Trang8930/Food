...
class BarSeller extends Component {
    render() {
        return (
            <>
                <nav className="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
                    <div className="container cont-seller">
                        <div className="menu-seller">
                            <NavLink className="navbar-brand menu-logo" to="/">Food<small>Ordering</small></NavLink>
                            ...
                            <div className="collapse navbar-collapse" id="ftco-nav">
                                ...
                                <li className="nav-item"><NavLink to="/yourProduct" className="nav-link nav-link-seller">Your Products</NavLink></li>
                                <li className="nav-item active"><NavLink to="/Login" className="nav-link">Logout</NavLink></li>
